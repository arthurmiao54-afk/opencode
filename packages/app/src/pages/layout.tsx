...
export default function Layout(props: ParentProps) {
  ...
  const projectListRow = () => (
    ...
    >
      ...
      <div class="flex-1" />
      <TooltipKeybind placement="bottom" title={language.t("sidebar.settings")} keybind={command.keybind("settings.open") ?? ""}>
        <IconButton
          icon="settings-gear"
          variant="ghost"
        ...
        <div class="flex-1 min-h-0 relative">
          <div class="size-full relative overflow-x-hidden">
            ...
            <div
              ...
              style={{ left: `${Math.max(layout.sidebar.width(), 244)}px` }}
            >
